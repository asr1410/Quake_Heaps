...
// Definitions
template <typename Key, typename Value>
QuakeHeap<Key, Value>::TEntry::TEntry(Key k, Value v) : _key(k),
														_value(v),
														_node(nullptr) {}
...
template <typename Key, typename Value>
QuakeHeap<Key, Value>::TNode::TNode(std::shared_ptr<TEntry> e) : _l(nullptr),
																 _r(nullptr),
																 _p(nullptr),
																 _height(0),
																 _entry(nullptr)
...
template <typename Key, typename Value>
QuakeHeap<Key, Value>::TNode::TNode(std::shared_ptr<TNode> l, std::shared_ptr<TNode> r) : _l(l),
																						  _r(r),
																						  _p(nullptr),
																						  _entry(nullptr)
{
...
template <typename Key, typename Value>
QuakeHeap<Key, Value>::QuakeHeap(float alpha) : _size(0),
												_alpha(alpha)
{
